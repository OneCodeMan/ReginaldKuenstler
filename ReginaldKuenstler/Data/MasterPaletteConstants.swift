...
struct MasterPaletteConstants {
    static let caravaggioImageStrings = ["caravaggio0", "caravaggio1", "caravaggio2", "caravaggio3", "caravaggio4", "caravaggio5"]
    
    static let goyaImageStrings = ["goya0", "goya1", "goya2", "goya3", "goya4", "goya5", "goya6", "goya7"]
    
    static let vanGoghImageStrings = ["vangogh0", "vangogh1", "vangogh2", "vangogh3", "vangogh4", "vangogh5", "vangogh6", "vangogh7"]
    ...
    static let gentileschiImageStrings = ["gentileschi0", "gentileschi1", "gentileschi2", "gentileschi3", "gentileschi4", "gentileschi5", "gentileschi6", "gentileschi7"]
    ...
    static let siemiradzkiImageStrings = ["siemiradzki0", "siemiradzki1", "siemiradzki2", "siemiradzki3", "siemiradzki4", "siemiradzki5", "siemiradzki6", "siemiradzki7"]
    
    static let hopperImageStrings = ["hopper0", "hopper1", "hopper2", "hopper3", "hopper4", "hopper5", "hopper6", "hopper7", "hopper8", "hopper9", "hopper10", "hopper11", "hopper12"]
